...
/**
 * Medicine administration instructions to the patient/carer. Part of MedicationDispense Model.
 */
@Data @NoArgsConstructor
@JsonTypeName(URNFactory.MODEL_PREFIX + "MedicationDispenseDosageInstruction")
