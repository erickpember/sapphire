...
/**
 * Processes transfer patient message.
 */
@MetaInfServices(MessageProcessor.class)
@Slf4j
public class ADT_A02_Processor extends AdmitDischargeProcessor {
  ...
  public void accept(Message input) {
    ...
    try {
      admitPatient(message.getMSH(), message.getPID(), message.getPV1());
