 ...
 */
@Slf4j
public class ADT_A02_TransformerTest {

  private static final String HL7_OBX_FILE = "ADT_A02_OBXtest.hl7";
  ...
  /**
   * Test of getApplicableMessageType method, of class ADT_A02_Transformer.
   */
  @Test
  public void testGetApplicableMessageType() {
    ADT_A02_Transformer transformer = new ADT_A02_Transformer();

    assertEquals(transformer.getApplicableMessageType(), ADT_A02.class);
  }

  /**
   * Test of transform method, of class ADT_A02_Transformer.
   *
  ...
  public void testTransform() throws IOException, HL7Exception, URISyntaxException {
    ...
    for (Event event : events) {
      ...
      if (event.getType().equals(EventType.OBSERVATIONS_ADD)) {
        ...
        assertEquals(obxList.size(), 3, "Wrong size of observations collected.");
        ...
        assertEquals(observation.getId(), "BW^BIRTH WEIGHT");
