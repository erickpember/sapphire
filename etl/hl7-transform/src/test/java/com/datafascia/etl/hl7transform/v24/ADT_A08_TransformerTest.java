 ...
 *
 * Gotcha: Hapi has no A08 type for v2.4, apparently A08 is to be parsed as a subtype of A01.
 *
 */
@Slf4j
public class ADT_A08_TransformerTest {

  private static final String HL7_OBX_FILE = "ADT_A08_OBXtest.hl7";
  ...
  /**
   * Test of getApplicableMessageType method, of class ADT_A08_Transformer.
   */
  @Test
  public void testGetApplicableMessageType() {
    ADT_A08_Transformer transformer = new ADT_A08_Transformer();

    // Gotcha: HAPI has no v24 A08 class, apparently treats A08 as a subtype of A01!
    assertEquals(transformer.getApplicableMessageType(), ADT_A01.class);
  }

  /**
   * Test of transform method, of class ADT_A08_Transformer.
   *
