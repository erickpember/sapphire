 ...
 */
@Slf4j
public class ADT_A13_TransformerTest {

  private static final String HL7_OBX_FILE = "ADT_A13_OBXtest.hl7";
  ...
  /**
   * Test of getApplicableMessageType method, of class ADT_A13_Transformer.
   */
  @Test
  public void testGetApplicableMessageType() {
    ADT_A13_Transformer transformer = new ADT_A13_Transformer();

    assertEquals(transformer.getApplicableMessageType(), ADT_A01.class);
  }

  /**
   * Test of transform method, of class ADT_A13_Transformer.
   *
