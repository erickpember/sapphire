...
public class TestUtil {
  /**
   * Inserts all the object into the KieRuntime and returns a Map with a relationship between each
   * object and their corresponding FactHandle
   *
   * @param runtime
   * @param objects
   * @return a Map with a relationship between each object and their corresponding FactHandle
   */
  public static Map<Object, FactHandle> insertAll(KieRuntime runtime, Object... objects) {
    Map<Object, FactHandle> factHandles = new HashMap<>(objects.length);
  ...
  /**
   * Creates a new StatelessKieSession that will be used for the rules. Its KieBase contains the drl
   * files sent by parameter.
   *
